...
export const StoragePopover: React.FC<PrometheusHealthPopupProps> = ({
  ...
  const operatorName = t('Rook Ceph');

  return (
    <Stack hasGutter>
      <StackItem>
        {t(
          "Storage status represents the health status of the StorageCluster."
        )}
      </StackItem>
      <StackItem>
        <StatusPopupSection
        ...
        >
          <div className="rook-status-popup__row">
            <Link to="/rook/overview">{operatorName}</Link>
