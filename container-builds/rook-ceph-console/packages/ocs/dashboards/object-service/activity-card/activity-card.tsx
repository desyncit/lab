...
import { useODFSystemFlagsSelector } from '@rook/core/redux';
import { ODFSystemFlagsPayload } from '@rook/core/redux/actions';
import { useGetClusterDetails } from '@rook/core/redux/utils';
import { secretResource } from '@rook/core/resources';
import {
  useCustomPrometheusPoll,
  usePrometheusBasePath,
} from '@rook/shared/hooks/custom-prometheus-poll';
import { EventModel } from '@rook/shared/models';
import { K8sResourceKind } from '@rook/shared/types';
import { useCustomTranslation } from '@rook/shared/useCustomTranslationHook';
import { getResiliencyProgress } from '@rook/shared/utils';
...
const ActivityCard: React.FC = () => {
  ...
  return (
    <Card className="rook-overview-card--gradient">
      <CardHeader>
